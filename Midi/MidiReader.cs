		...
		string StringTrackInfo
		{
			get {
				return string.Format(
					...
					TimeSignature.Numerator,TimeSignature.Denominator, TimeSignature.Clocks, TimeSignature.ThirtySeconds,
					KeySignature.KeyType, KeySignature.IsMajor ? "Major" : "Minor"
				);
			}
		}
